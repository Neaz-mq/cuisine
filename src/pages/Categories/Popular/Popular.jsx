        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-14">
          ...
          >
            ...
            <div className="relative z-20 text-white bg-[#FF4C15] 3xl:p-10 2xl:p-8 xl:p-8 lg:p-8 md:p-8 sm:p-6 3xl:bottom-36 2xl:bottom-44 xl:bottom-52 lg:bottom-52 md:bottom-52 sm:bottom-10 mx-6">
              ...
              <div className="flex sm:flex-col 3xl:flex-row 2xl:flex-row xl:flex-row lg:flex-row md:flex-row 3xl:space-x-3 2xl:space-x-3 xl:space-x-3 lg:space-x-1 mb-6" role="timer" aria-label="Countdown to deal end">
