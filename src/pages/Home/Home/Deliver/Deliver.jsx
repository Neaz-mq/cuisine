const Deliver = () => {
  return (
   <div className="container mx-auto">
     <div className="relative bg-white px-8 3xl:px-32 2xl:px-28 xl:px-20 lg:px-10 3xl:mt-20 2xl:mt-20 xl:mt-32 lg:mt-32 mb-52">
      {/* Main Grid */}
      <div className="grid grid-cols-1 3xl:grid-cols-2 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 gap-8 items-center">
        {/* Left Text Content */}
        <div className="space-y-6 3xl:ml-14 2xl:ml-24 xl:ml-[7.5rem] lg:ml-12 3xl:-mt-0 2xl:-mt-6 xl:-mt-10 lg:-mt-8">
        ...
        <div
          className="flex justify-end relative 3xl:-left-4 2xl:left-2 xl:left-2 lg:-left-4  "
          style={{
