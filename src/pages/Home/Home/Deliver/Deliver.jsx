...
const Deliver = () => {
  return (
    <Container>
      <div className="relative bg-white px-8 3xl:px-3 2xl:px-2 xl:px-2 lg:px-10 3xl:mt-20 2xl:mt-20 xl:mt-32 lg:mt-32 mb-44">
        {/* Main Grid */}
        <div className="grid grid-cols-1 3xl:grid-cols-2 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 gap-8 items-center">
          {/* Left Text Content */}
          <div className="space-y-6 3xl:ml-14 2xl:ml-12 xl:ml-12 lg:ml-3 3xl:-mt-0 2xl:-mt-6 xl:-mt-10 lg:-mt-8">
