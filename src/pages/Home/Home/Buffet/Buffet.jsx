        ...
        <Container>
            <div className="mb-36 z-50 3xl:mt-28 2xl:mt-20 xl:mt-16 lg:mt-14 3xl:-ml-0">
                <div className="mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Food Cards Section */}
                    <div className="grid grid-cols-1 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 3xl:grid-cols-4 3xl:gap-12 2xl:gap-6 xl:gap-3 lg:gap-3 mb-12 3xl:mt-20 2xl:mt-16 xl:mt-14 lg:mt-12 3xl:px-8 2xl:px-0 xl:px-2 lg:px-0 2xl:-ml-6 3xl:-ml-0">
                    ...
                    <div className="flex flex-col md:flex-row items-stretch  overflow-hidden 3xl:px-6 2xl:px-0 xl:px-2 lg:px-2 2xl:-ml-5 3xl:-ml-0 ">
                        {/* Left Text */}
