...
const Services = () => {
    ...
    return (
        <div className='relative 3xl:-mt-[41rem] 2xl:-mt-[37rem] xl:-mt-[44rem] flex justify-center'>
            <div className="bg-white relative 3xl:w-[83.5rem] 3xl:h-[70rem] 2xl:w-[71rem] 2xl:h-[70rem] xl:w-[53rem] xl:h-[65rem]  rounded-[120px] mb-80 z-50 -mt-[20rem]  ">
                <div className='3xl:mt-14 2xl:mt-14 xl:mt-10 flex justify-center items-center text-center px-4'>
                    <h1 className='text-[#888888] 3xl:text-base 2xl:text-base xl:text-sm font-normal leading-relaxed max-w-2xl'>
                ...
                <div className="relative w-full flex flex-col items-center justify-center 3xl:-mt-[36rem] 2xl:-mt-[38rem] xl:-mt-[46rem]  mb-8">
                    {/* Background Image */}
                    <div
                    ...
                    <div className="relative z-10 text-center mt-[51rem]">
                        <h2 className="text-gray-500 text-xs font-semibold tracking-wide mb-2">
                            <span className="bg-[#FF4C15] text-white py-1 px-4 rounded-full flex items-center justify-center transform rotate-[5deg] w-fit mx-auto 3xl:mt-0 2xl:mt-16 xl:mt-6">
                        ...
                        <h1 className="text-5xl font-semibold text-[#2C6252] 3xl:mt-10 2xl:mt-16 xl:mt-12  mb-6">
                            What Makes Us Stand Out
                        </h1>
                    </div>

                    {/* Services Grid */}
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-14  mt-14 3xl:px-28 2xl:px-12 xl:px-6">
                        {services.map((service, index) => (
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-[#CCCCCC] 3xl:text-[12px] 2xl:text-[10px] xl:text-[8px] py-2">
                                        {service.desc}
                                    </p>
