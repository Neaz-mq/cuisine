    ...
    return (
        <div className="relative bg-white z-0 ml-36">
            ...
            <div className="flex items-start justify-between">
                ...
                <div className="relative overflow-hidden 3xl:-mt-[20rem] 3xl:ml-[6rem] 2xl:-mt-40 xl:-mt-40 lg:-mt-36  2xl:ml-2">
                    <img src="https://res.cloudinary.com/dxohwanal/image/upload/v1744105102/pngegg_27_jjdv28.png" alt="Banner" className="w-full 3xl:h-[68rem] 2xl:h-[50rem] xl:h-[46rem] lg:h-[40rem]  object-cover 3xl:ml-36  2xl:ml-10 lg:ml-6" />
                </div>
            </div>
