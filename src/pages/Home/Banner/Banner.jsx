            ...
            <Container>
                <div className="relative bg-white">
                    <div className="flex items-start justify-between">
                        {/* Left Side Content */}
                        <div className="relative 3xl:p-8 2xl:p-8 xl:p-8 lg:p-0 top-4 3xl:left-2">
                            <img
                        ...
                        <div className="relative 3xl:-mt-36 3xl:-ml-20 2xl:-ml-16 w-full 2xl:-mt-36 xl:-mt-28 xl:-ml-16 lg:-mt-[7.2rem] lg:-ml-32 object-cover z-20">
                            <img
                                ...
                                alt=""
                                className="3xl:w-full 2xl:w-full xl:w-[44rem] lg:w-[30rem] 3xl:-ml-24 2xl:-ml-10 xl:-ml-16 lg:-ml-0 3xl:h-[50rem] 2xl:h-[44rem] xl:h-[38rem] lg:h-[30rem] object-cover"
                            />
                        </div>
                    </div>
