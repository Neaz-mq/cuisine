                ...
                <div className="bg-gray-50 p-6 border border-gray-200 rounded-lg space-y-4">
                    ...
                    <div className="space-y-4">
                        {[1, 2].map((item, i) => (
                            <div key={i} className="flex items-start gap-4">
                                <img
                                    src={`https://via.placeholder.com/60x60?text=Item+${i + 1}`}
                                    alt="item"
                                    className="w-16 h-16 rounded object-cover"
                                />
                                <div className="flex-1">
                                    <p className="font-medium text-sm text-gray-800">Cheesy Crust Deluxe</p>
                                    <p className="text-xs text-gray-500">Some amazing crispy food description</p>
                                </div>
                    ...
                    <div className="pt-4 space-y-10 border-t border-gray-200">
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <button className="bg-gray-700 text-white text-sm px-3 py-2 rounded">Apply</button>
                        </div>
                        ...
                        <div className="flex justify-between text-md font-bold pt-2">
                            <span>Total</span>
                            <span className="text-green-700">USD $10</span>
                        </div>
                    </div>
                </div>
            </div>
