...
const Footer = () => {
  return (
    <footer className="bg-[#2C6252] text-white">
      {/* Top Footer Content */}
      <Container>
        <div className="px-6 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 3xl:gap-10 2xl:gap-14 xl:gap-4 lg:gap-10 text-center lg:text-left">
          {/* Logo */}
          <div className="flex justify-center 3xl:justify-center items-start w-full 3xl:ml-8 2xl:ml-20 2xl:justify-start xl:ml-1 xl:justify-start lg:justify-start">
            <a href="/">
      ...
      <div className="w-full flex justify-center">
        <Container>
          <div className="border-t border-[#ACBCB8] 3xl:w-[80rem] 2xl:w-[62rem] xl:w-[62rem] lg:w-[49rem] mt-6 mb-12 3xl:ml-36 2xl:ml-28 xl:ml-7 lg:ml-7"></div>
        </Container>
      </div>
      ...
      <div className="bg-[#FF4C15] w-full flex justify-center">
        <Container>
          <div className="flex flex-col md:flex-row justify-center md:justify-between items-center px-6 py-4 text-sm text-white gap-4 3xl:ml-28 2xl:ml-20 xl:ml-0">
