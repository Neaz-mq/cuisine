    ...
    <footer className="bg-[#2C6252] text-white">
      ...
      <Container>
        <div className="px-6 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 3xl:gap-10 2xl:gap-14 xl:gap-16 lg:gap-20 text-center lg:text-left">
          {/* Logo */}
          <div className="flex justify-center 3xl:justify-center items-start w-full 3xl:ml-8 2xl:ml-20 2xl:justify-start xl:ml-[7.4rem] lg:ml-[6.1rem] xl:justify-start lg:justify-start">
            <a href="/">
