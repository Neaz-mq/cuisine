...
const Navbar = () => {
  ...
  return (
    ...
    >
      {/* Cuisine Logo */}
      <Link to="/" aria-label="Cuisine Home">
        <div className="absolute left-0 top-0 w-10 md:w-20 lg:w-20 xl:w-24 2xl:w-28 3xl:w-32 bg-[#2C6252] flex flex-col items-center py-3 xl:py-4">
          ...
          />
          <span
            className="sm:text-[13px] md:text-[12px] lg:text-[10px] xl:text-[13px] 2xl:text-[15px] 3xl:text-lg font-bold text-white mt-4 md:ml-8 lg:ml-10 xl:ml-10 2xl:ml-[3.9rem] 3xl:ml-20 vertical-rl"
      ...
      <button className="hidden lg:flex bg-[#FF4C15] flex-col items-center 3xl:py-4 3xl:px-3 2xl:py-3 2xl:px-3 xl:py-3 xl:px-3 lg:py-2 lg:px-2 w-full 3xl:ml-32 2xl:ml-24 xl:ml-14 lg:ml-12 3xl:mt-10 2xl:mt-6 xl:mt-4 lg:mt-4">
        <Link to="/table" aria-label="Book a Table">
          <span
            className="3xl:text-[18px] 2xl:text-[15px] xl:text-[13px] lg:text-[9px] font-bold text-white vertical-rl"
            style={{ transform: 'rotate(180deg)' }}
          >
            Book a Table
          </span>
