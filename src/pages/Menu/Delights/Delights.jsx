const Delights = () => {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 py-12 max-w-7xl mx-auto mt-20">
            ...
            <div className="flex flex-col bg-white overflow-hidden p-6">
                ...
                <div className="flex flex-col mt-16">
                    ...
                    <div className="flex items-center justify-between mt-6"> {/* Added flex, items-center, justify-between */}
                        ...
                        <button className="bg-[#FF4C15] text-white px-3 py-2  hover:bg-orange-600 text-lg font-semibold -mt-4">
                            Order Now
                        </button>
                    </div>
                </div>
            ...
            <div className="relative  overflow-hidden w-full h-auto lg:h-[700px] bg-white  p-6 flex -top-3 right-4" >
                ...
                <img
                    ...
                    alt="Fish Dish"
                    className="absolute bottom-0 right-0 left-60 w-3/5 h-auto object-contain z-0 top-80"
                />
            </div>
        </div>
    );
