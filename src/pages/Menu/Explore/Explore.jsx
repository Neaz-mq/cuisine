          ...
          <div className="flex flex-col sm:flex-row items-start justify-between " >
            ...
            >
              <img
                ...
                className="w-full max-w-[380px] sm:max-w-[500px] md:max-w-[400px] 3xl:max-w-[800px] 2xl:max-w-[800px] xl:max-w-[800px] lg:max-w-[800px] object-contain mt-4 sm:mt-3 sm:ml-10   "
              />
