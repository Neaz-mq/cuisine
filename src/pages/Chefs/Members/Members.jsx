    ...
    return (
        <Container>
            ...
            >
                {/* Header Section */}
                <Motion.div
                    className="mb-10 md:mb-16 text-left flex justify-end items-center sm:ml-[7.4rem] 3xl:ml-0 2xl:ml-0 xl:ml-0 md:ml-0 sm:w-60 3xl:w-full 2xl:w-full xl:w-full lg:w-full md:w-full"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 3xl:gap-8 2xl:gap-8 xl:gap-8 lg:gap-4  items-center sm:w-[15rem] 3xl:w-full 2xl:w-full xl:w-full lg:w-full md:w-full ">
                    ...
                    {/* Left Image Area */}
                    <Motion.figure
                        className="flex justify-end relative 3xl:left-2 2xl:-left-14 xl:-left-[7.5rem] lg:left-2 md:left-4 sm:left-[7.4rem] bg-[#3F7765] 3xl:h-[99%] 3xl:w-[75%] 2xl:h-[99.8%] 2xl:w-[80%] xl:h-[99.8%] xl:w-[94%] lg:h-[99.8%] lg:w-[95%] md:w-[94%] sm:w-[90%] "
                        role="img"
                    ...
                    {/* Right - Team Cards */}
                    <Motion.div
                        className="grid grid-cols-1  md:grid-cols-2 3xl:gap-x-20 3xl:gap-y-20 2xl:gap-x-36 2xl:gap-y-20 xl:gap-x-40 xl:gap-y-24 lg:gap-x-5 lg:gap-y-12 md:gap-x-0 md:gap-y-24 sm:gap-x-0 sm:gap-y-16 3xl:ml-20 2xl:ml-0 xl:ml-10 lg:-ml-1 md:ml-20 sm:ml-32 md:mt-16 3xl:mt-0 2xl:mt-0 xl:mt-0 lg:mt-0 sm:mt-20 sm:w-[13rem] 3xl:w-full 2xl:w-full xl:w-full lg:w-full md:w-[30rem]  "
                        initial="hidden"
                        whileInView="visible"
                        variants={{
                            hidden: {},
                        ...
                        {teamMembers.map((member) => (
                            ...
                            >
                                ...
                                <div className="relative z-10 w-full mt-auto flex flex-col items-center text-gray-700 bg-white bg-opacity-75 rounded-md px-2 py-1">
                                    ...
                                    <div className="flex justify-center space-x-1 text-yellow-400" aria-label="Rating">
