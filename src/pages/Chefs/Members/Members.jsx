                    ...
                    >
                        {teamMembers.map((member) => (
                            ...
                            >
                                ...
                                <figcaption className="absolute 3xl:-left-8 2xl:-left-4 xl:-left-4 lg:-left-3 md:-left-3 sm:-left-3 top-28 3xl:-translate-y-1/2 2xl:-translate-y-1/2 xl:-translate-y-1/2 lg:-translate-y-1/2 md:-translate-y-1/2 sm:-translate-y-8 -rotate-90 origin-left 3xl:text-lg 2xl:text-lg xl:text-lg lg:text-sm sm:text-xs font-semibold text-[#2C6252] whitespace-nowrap z-20">
                                    - {member.name}
                                </figcaption>
