    ...
    return (
        <Container>
            ...
            >
                {/* Header Section */}
                <Motion.div
                    className="mb-10 md:mb-16 text-left flex justify-end items-center sm:ml-[7.4rem] 3xl:ml-0 2xl:ml-0 xl:ml-0 md:ml-0 sm:w-64 3xl:w-full 2xl:w-full xl:w-full lg:w-full md:w-full"
