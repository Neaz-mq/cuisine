        ...
        <Container>
            <div className="py-8 md:py-12 3xl:px-16 2xl:px-20 xl:px-44 lg:px-0 3xl:mt-36 2xl:mt-36 xl:mt-36 lg:mt-24  3xl:mb-52 2xl:mb-40 xl:mb-28 lg:mb-28 ">
                ...
                <div className="mb-10 md:mb-16 text-left flex justify-end items-center "> {/* Ensures overall text alignment is left */}
                    <h1 className="text-3xl  3xl:text-5xl 2xl:text-4xl xl:text-2xl lg:text-2xl font-bold text-[#2C6252] mb-2 leading-relaxed 3xl:mr-8 2xl:mr-16 xl:-mr-16 lg:mr-20 "> {/* Removed mb-4 md:mb-0 and text-right */}
                        ...
                        <span className="inline-flex items-center leading-relaxed">
                            members
                            <span className="bg-[#FF4C15] text-white 3xl:text-sm 2xl:text-sm xl:text-sm lg:text-[10px] px-4 py-2  flex items-center space-x-2 ml-4"> {/* Added ml-4 for spacing */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 3xl:gap-8 2xl:gap-8 xl:gap-8 lg:gap-4 items-center">
                    ...
                    >
                        <div className="3xl:-ml-16 3xl:-mr-[22.4rem] 3xl:-mt-32 2xl:-ml-60 2xl:-mr-[20rem] xl:-ml-36 xl:-mr-[27rem] 2xl:-mt-36  xl:-mt-48 lg:-ml-44 lg:-mr-[7rem] lg:-mt-48">
                            <img
                    ...
                    {/* Team Members Grid */}
                    <div className="grid grid-cols-2 3xl:gap-x-20 3xl:gap-y-20 2xl:gap-x-36 2xl:gap-y-20 xl:gap-x-40 xl:gap-y-24 lg:gap-x-5 lg:gap-y-12  3xl:ml-20 2xl:ml-0 xl:ml-10">
                        {teamMembers.map((member) => (
                           <div key={member.id} className="relative bg-white  p-4 flex flex-col justify-end items-center text-center 3xl:h-[200px] 3xl:w-[250px] 2xl:h-[200px] 2xl:w-[220px] xl:h-[200px] xl:w-[170px] lg:h-[150px] lg:w-[180px] border  border-gray-400"> {/* Increased height and overflow-visible */}
