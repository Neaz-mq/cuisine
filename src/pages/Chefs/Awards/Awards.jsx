  ...
  return (
    <Container>
      <div className="relative  overflow-hidden min-h-[1800px] 3xl:-mt-0 2xl:-mt-40 xl:-mt-28 lg:-mt-44 3xl:right-10 ">
        ...
        <div className="absolute left-1/2 lg:top-80 xl:top-64 2xl:top-[21rem] 3xl:top-48 z-50 lg:-translate-x-[210px] xl:-translate-x-[310px] 2xl:-translate-x-[420px] 3xl:-translate-x-[580px]">
        ...
        {/* Live Kitchen */}
        <div className="absolute left-1/2 lg:top-72 xl:top-[16rem] 2xl:top-[23.5rem] 3xl:top-64  text-gray-800 px-3 py-1 rounded-full text-[26px] z-50 lg:translate-x-[120px] xl:translate-x-[180px] 2xl:translate-x-[270px] 3xl:translate-x-[430px]">
