...
const Awards = () => {
  return (
    <Container>
      <div className="relative overflow-hidden min-h-[1800px] 3xl:-mt-12 2xl:-mt-12 xl:-mt-28 lg:-mt-44 3xl:right-10 2xl:right-20 ">
        ...
        <div className="absolute left-1/2 lg:top-[33%] xl:top-[38%] 2xl:top-[50%] 3xl:top-[54%] z-10 translate-x-[-50%] translate-y-[-104%] flex items-center justify-center">
          <img
            ...
            alt="Awards"
            className="lg:w-[420px] xl:w-[620px] 2xl:w-[1100px] 3xl:w-[1250px] max-w-none"
          />
        </div>
        ...
        <Motion.div
          className="absolute 3xl:left-28 2xl:left-16 lg:top-80 xl:top-64 2xl:top-[13rem] 3xl:top-48 z-50 "
          animate={{ y: [0, -20, 0] }}
        ...
        {/* Green Food */}
        <div className="absolute left-1/2 lg:top-[25rem] xl:top-[20rem] 2xl:top-[22rem] 3xl:top-72 z-50 lg:-translate-x-[140px] xl:-translate-x-[180px] 2xl:-translate-x-[300px] 3xl:-translate-x-[320px]">
        ...
        {/* Healthy Food */}
        <div className="absolute left-1/2 lg:top-[27rem] xl:top-[28rem] 2xl:top-[36rem] 3xl:top-[33rem] z-50 lg:-translate-x-[240px] xl:-translate-x-[380px] 2xl:-translate-x-[440px] 3xl:-translate-x-[520px]">
        ...
        {/* Experiences Tag */}
        <Motion.div
          className="absolute 3xl:left-[24rem] 2xl:left-[18rem] lg:top-[19rem] xl:top-60 2xl:top-44 3xl:top-36 z-50 rounded-full px-4 py-2 lg:-translate-x-[150px] xl:-translate-x-[205px] 2xl:-translate-x-[250px] 3xl:-translate-x-[300px] 3xl:w-36 2xl:w-36 xl:w-32 lg:w-24"
        ...
        {/* 24/7 Open (top right) */}
        <div className="absolute left-1/2 lg:top-72 xl:top-[14rem] 2xl:top-52 3xl:top-48 text-gray-800 px-3 py-1 text-lg z-50 lg:translate-x-[40px] xl:translate-x-[80px] 2xl:translate-x-[200px] 3xl:translate-x-[200px]">
        ...
        {/* 5 Star Rating */}
        <Motion.div
          className="absolute 3xl:right-[34rem] 2xl:right-[25rem]  lg:top-[21.5rem] xl:top-[19rem] 2xl:top-[18rem] 3xl:top-72 bg-white rounded-full border border-gray-400 shadow-md py-1 px-3 text-yellow-400 text-base z-50 lg:translate-x-[30px] xl:translate-x-[70px] 2xl:translate-x-[100px] 3xl:translate-x-[100px]"
          animate={{ y: [0, -20, 0] }}
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        >
          ★★★★★
        ...
        <Motion.div
          className="absolute left-1/2 lg:top-72 xl:top-[16rem] 2xl:top-[16rem] 3xl:top-64 text-gray-800 px-3 py-1 rounded-full text-[26px] z-50 lg:translate-x-[120px] xl:translate-x-[180px] 2xl:translate-x-[350px] 3xl:translate-x-[430px]"
          initial={{ opacity: 0 }}
        ...
        {/* Organic Food */}
        <div className="absolute left-1/2 lg:top-[24rem] xl:top-[23rem] 2xl:top-[24rem] 3xl:top-96 px-3 py-1 text-lg z-50 lg:translate-x-[55px] xl:translate-x-[90px] 2xl:translate-x-[190px] 3xl:translate-x-[210px]">
      ...
      <div className="absolute left-1/2 3xl:top-[52rem] 2xl:top-[48rem]  translate-x-[-45%] z-50 w-full 3xl:max-w-[1220px] 2xl:max-w-[1200px]  ">
        <div className="grid grid-cols-3 text-white font-bold text-center text-4xl divide-x divide-[#CCCCCC] bg-[#406D5B]  overflow-hidden 3xl:px-24 3xl:py-24 2xl:px-20 2xl:py-20  3xl:-ml-6">
