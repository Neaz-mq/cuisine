                ...
                <div className="lg:col-span-2 flex flex-col space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-[#F8F8F8] p-8  flex flex-col items-start text-left">
                            ...
                            <div className="mb-4 bg-white p-3   flex items-end justify-end w-full">
                               <img src="/call.svg" alt="" />
                            </div>
                            <h3 className="text-xl md:text-2xl font-bold text-[#3F7765] mb-2 mt-2">Outstanding Customer Service</h3>
                    ...
                    <div className="bg-[#2D6A5E] p-6 md:p-10  text-left text-white mt-6">
                        <h2 className="text-3xl md:text-4xl font-bold mb-3 ">Enjoy unbeatable</h2>
                        <h2 className="text-3xl md:text-4xl font-bold mb-4 ">deals every</h2>
                        <p className="text-base md:text-sm opacity-90 mt-6">
