    ...
    return (
        <Container>
            <div className="3xl:px-12 3xl:ml-7 3xl:mb-24 2xl:px-1 2xl:ml-7 2xl:mb-24 xl:px-6 xl:ml-7 xl:mb-24 lg:px-1 lg:-ml-3 lg:mb-24">
                ...
                <div className="max-w-xl mx-auto px-4 sm:px-6 3xl:px-10 2xl:px-10 xl:px-10 lg:px-20 -mt-10 md:-mt-16 relative z-20 left-28">
                ...
                {/* Features Section */}
                <div className=" 3xl:px-4 2xl:px-0 xl:px-0 lg:px-4 sm:px-6  py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 3xl:gap-72 2xl:gap-44 xl:gap-36 lg:gap-28 text-center mt-20 whitespace-nowrap">
                    <div className="flex flex-col items-center p-4">

                        <div className="3xl:text-5xl 2xl:text-5xl xl:text-5xl lg:text-3xl text-gray-700 mb-4">🚚</div>
                        <h3 className="font-semibold 3xl:text-xl 2xl:text-xl xl:text-xl lg:text-lg">Speedy Delivery</h3>
                    ...
                    <div className="flex flex-col items-center p-4">
                        ...
                        <div className="3xl:text-5xl 2xl:text-5xl xl:text-5xl lg:text-3xl text-gray-700 mb-4">📞</div>
                        <h3 className="font-semibold 3xl:text-xl 2xl:text-xl xl:text-xl lg:text-lg">24/7 Customer Support</h3>
                         <p className="text-[10px] text-[#CCCCCC] mt-4">Our menu is carefully crafted <br /> by expert 
                            chefs </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center p-4">
                        ...
                        <div className="3xl:text-5xl 2xl:text-5xl xl:text-5xl lg:text-3xl text-gray-700 mb-4">🛒</div>
                        <h3 className="font-semibold 3xl:text-xl 2xl:text-xl xl:text-xl lg:text-lg">One-Stop Shop</h3>
                         <p className="text-[10px] text-[#CCCCCC] mt-4">Our menu is carefully crafted <br /> by expert 
                            chefs </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center p-4">
                        ...
                        <div className="3xl:text-5xl 2xl:text-5xl xl:text-5xl lg:text-3xl text-gray-700 mb-4">❤️</div>
                        <h3 className="font-semibold 3xl:text-xl 2xl:text-xl xl:text-xl lg:text-lg">Crafted with Care</h3>
                         <p className="text-[10px] text-[#CCCCCC] mt-4">Our menu is carefully crafted <br /> by expert 
                            chefs </p>
                    </div>
                </div>
