      ...
      <main className="3xl:px-12 3xl:ml-7 3xl:mb-24 2xl:px-1 2xl:ml-7 2xl:mb-24 xl:px-6 xl:ml-7 xl:mb-24 lg:px-1 lg:-ml-3 lg:mb-24 ">
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 3xl:px-10 2xl:px-10 xl:px-10 lg:px-10 flex flex-col md:flex-row items-center md:items-start justify-between">
            ...
            >
              <h1
                id="roast-header"
                className="text-3xl 3xl:text-4xl 2xl:text-4xl xl:text-3xl lg:text-3xl font-bold mb-4 mt-12"
              >
        ...
        >
          <div className="bg-white p-12 text-center md:text-left max-w-xl shadow-lg mx-auto relative 3xl:left-64 2xl:left-36 xl:left-24 lg:left-10">
            <h2
              id="unbeatable-deals"
              className="3xl:text-3xl 2xl:text-2xl xl:text-2xl lg:text-xl font-bold text-[#2C6252] mb-4 leading-normal"
            >
        ...
        >
          {[
            ...
            >
              <div className="3xl:text-5xl 2xl:text-5xl xl:text-5xl lg:text-3xl text-gray-700 mb-4" aria-hidden="true">
                {feature.icon}
              </div>
