          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 3xl:grid-cols-4 2xl:grid-cols-4 3xl:gap-6 2xl:gap-6 xl:gap-4 lg:gap-6 md:gap-6 sm:gap-6 w-fit">
            {visibleItems.map((item, index) => (
              <Motion.article
                ...
                className={`bg-white overflow-hidden 3xl:w-[250px] 2xl:w-[220px] xl:w-[190px] lg:w-[190px] md:w-[170px] sm:w-[150px] ${item.id === 4 ? "3xl:block 2xl:block xl:block lg:hidden hidden" : ""
                  }`}
              >
                <figure>
                  <img
