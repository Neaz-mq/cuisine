  ...
  return (
    <Container>
      ...
      <section
        ...
        className="3xl:px-12 3xl:ml-7 3xl:mt-40 3xl:mb-52 2xl:px-0 2xl:ml-6 2xl:-mt-2 2xl:mb-44 xl:px-6 xl:ml-7 xl:-mt-2 xl:mb-36 lg:px-2 lg:-ml-5 lg:-mt-2 lg:mb-40 md:px-2 md:-ml-12 md:-mt-2 md:mb-40 sm:px-2 sm:-ml-5 sm:-mt-2 sm:mb-40 overflow-hidden"
      >
        <Motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          {/* Top Section Grid */}
          <div className="grid grid-cols-1 3xl:grid-cols-2 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 3xl:gap-12 2xl:gap-12 xl:gap-12 lg:gap-12 md:gap-4 gap-0 3xl:mb-24 2xl:mb-24 xl:mb-24 lg:mb-16 md:mb-16 sm:mb-16">
            {/* Left Hero Card */}
            <Motion.article
            ...
            >
              <h2
                id="picks-heading"
                className="text-3xl 3xl:text-5xl 2xl:text-4xl xl:text-3xl lg:text-2xl md:text-2xl sm:text-2xl font-semibold text-[#2C6252] 3xl:mb-4 2xl:mb-4 xl:mb-4 lg:mb-4 md:mb-6"
              >
            ...
            <div className="space-y-8" role="list" aria-label="Promotional cards">
              ...
              >
                <div className="w-2/3 pr-4">
                  ...
                  <p className="3xl:text-sm 2xl:text-sm xl:text-[10px] lg:text-[9px] md:text-[10px] mb-4 text-[#BCB1AD]">
          ...
          >
            <div className="flex flex-col md:flex-row md:items-start md:space-x-8 mb-6">
              <div className="flex items-center flex-shrink-0 mb-4 md:mb-0 md:w-1/3">
                <h2 className="3xl:text-3xl 2xl:text-2xl xl:text-2xl lg:text-xl md:text-base font-semibold text-[#2C6252] whitespace-nowrap">
                  Chef's Weekly Picks{" "}
                </h2>
              ...
              <div className="md:w-2/3 3xl:-mt-3 2xl:-mt-3 xl:-mt-3 lg:-mt-3 md:-mt-0">
                <p className="3xl:text-sm 2xl:text-sm xl:text-sm lg:text-[10px] md:text-[12px] text-[#BCB1AD] leading-relaxed mb-4 3xl:ml-[13.5rem] 2xl:ml-[11.2rem] xl:ml-[10rem] lg:ml-[8.2rem]">
                ...
                <p className="3xl:text-sm 2xl:text-sm xl:text-sm lg:text-[10px] md:text-[12px] text-[#FF4C15] leading-relaxed 3xl:ml-[13.5rem] 2xl:ml-[11.2rem] xl:ml-[10rem] lg:ml-[8.3rem]">
                ...
                return (
                  ...
                  >
                    <div className="p-4">
                      ...
                      <p className="mt-6 3xl:text-xs 2xl:text-xs xl:text-xs text-[#2D6252] lg:text-xs md:text-xs">
                    ...
                    <img
                      ...
                      className={`w-full object-cover mt-6 ${
                        i === 2 ? " 3xl:mt-20 2xl:mt-20 xl:mt-16 lg:mt-16 md:mt-20" : ""
                      }`}
                      draggable={false}
                    />
                    <div
                      className="absolute right-6 3xl:top-80 2xl:top-80 xl:top-80 lg:top-72 md:top-72 sm:top-72 text-white rounded-full 3xl:w-20 3xl:h-20 2xl:w-16 2xl:h-16 xl:w-16 xl:h-16 lg:w-14 lg:h-14 md:w-14 md:h-14 sm:h-14 flex flex-col items-center justify-center"
